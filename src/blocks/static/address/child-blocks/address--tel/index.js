...
export const name = 'ksd/address--tel';

export const settings = {
    apiVersion: 2,
    title: __('Phone', 'kotisivu-theme-blocks'),
    description: __('Phone field for Address Block', 'kotisivu-theme-blocks'),
    category: 'design',
    icon: 'columns',
    parent: ['ksd/address'],
        ...
        return (
            <div {...blockProps}>
                ...
                <AddressWrapper {...props} >
                    <AddressIcon {...props} />
                    <RichText
                        className="address__content address__content--tel"
                        value={content}
    ...
    save: (props) => {
        ...
        return (
            <AddressWrapper {...props} >
                ...
                <RichText.Content className="address__content address__content--tel" value={content} />
            </AddressWrapper>
        );
    }
}